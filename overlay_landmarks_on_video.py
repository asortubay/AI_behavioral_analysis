    ...
    with tqdm(total=total_frames, desc=f"Overlaying landmarks on {os.path.basename(video_path)}", unit="frame") as pbar:
        while frame_number < total_frames:
            ...
            try:
                ...
                frame_with_landmarks = draw_landmarks_on_frame_multi_person(frame, multi_person_data, frame_number)
...
def process_videos_in_directory(input_dir, output_landmarks_dir, overlay_output_dir):
